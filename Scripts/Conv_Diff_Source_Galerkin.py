...
N=70; Ns=(N-1)**2; Nt=50; h=1./N; Tfinal = 2.; k=Tfinal/Nt; t=np.linspace(0,Tfinal,Nt+1)
x1,x2=np.meshgrid(np.linspace(0,1,N+1)[1:-1],np.linspace(0,1,N+1)[1:-1],indexing='xy')
